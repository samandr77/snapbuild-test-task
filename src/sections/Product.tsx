...
/**
 * Продукт — секция собрана как на исходном сайте: заголовок и вкладки форматов
 * стоят в одну строку, под ними две колонки. Слева карточки возможностей
 * выбранного формата, справа кадр выбранной возможности на градиентной панели.
 *
